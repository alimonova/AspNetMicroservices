...
namespace Discount.Grpc.Services
{
	public class DiscountService : DiscountProtoService.DiscountProtoServiceBase
	{
        ...
        public async override Task<CouponModel> CreateDiscount(CreateDiscountRequest request,
            ServerCallContext context)
        {
            var coupon = _mapper.Map<Coupon>(request.Coupon);
            await _repository.CreateDiscount(coupon);
            _logger.LogInformation("Discount was successfully created. ProductName : {productName}",
                coupon.ProductName);
            ...
            ServerCallContext context)
        {
            ...
            _logger.LogInformation("Discount was successfully updated. ProductName : {productName}",
                coupon.ProductName);
